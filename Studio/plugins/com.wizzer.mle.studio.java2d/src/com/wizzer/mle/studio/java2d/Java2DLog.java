 ...
 * @author Mark S.Millard
 */
public class Java2DLog implements ILog
{
	// A singleton instance of the Magic Lantern Studio log.
	private static Java2DLog m_log = null;
	...
	{
		if (Java2DPlugin.getDefault() != null)
			Java2DPlugin.getDefault().getLog().log(
				new Status(Status.ERROR, Java2DPlugin.getID(), Status.OK, message, ex));
	}
	...
	private static void logEclipseWarning(String message)
	{
		if (Java2DPlugin.getDefault() != null)
			Java2DPlugin.getDefault().getLog().log(
				new Status(Status.WARNING, Java2DPlugin.getID(), Status.OK, message, null));
	}
	...
	private static void logEclipseInfo(String message)
	{
		if (Java2DPlugin.getDefault() != null)
			Java2DPlugin.getDefault().getLog().log(
				new Status(Status.INFO, Java2DPlugin.getID(), Status.OK, message, null));
	}
	 ...
	 */
	public static Java2DLog getInstance()
	{
		if (m_log == null)
			m_log = new Java2DLog();
		return m_log;
