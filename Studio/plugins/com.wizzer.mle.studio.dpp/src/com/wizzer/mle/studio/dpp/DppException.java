 ...
 * while mastering a <i>Digital Workprint</i>.
 * 
 * @author Mark S. Millard
 */
public class DppException extends Exception
{
	/**
	 ...
	 */
    public DppException(String message)
    {
        super(message);
    }
	 ...
	 */
    public DppException(Throwable cause)
    {
        super(cause);
    }
	 ...
	 * and indicates that the cause is nonexistent or unknown.
	 */
    public DppException(String message, Throwable cause)
    {
        super(message, cause);
    }
