/*
 * GengroupIncrementalBuildVisitor.java
 ...
 */
public class GengroupIncrementalBuildVisitor implements IResourceDeltaVisitor
{
     ...
     */
    public GengroupIncrementalBuildVisitor(IProgressMonitor monitor)
    {
        super();
        m_monitor = monitor;
    }
