 ...
 * mastering step, <i>gentables</i>.
 * 
 * @author Mark S. Millard
 */
public class GentablesBuilder extends IncrementalProjectBuilder
{
    /**
     * The default constructor.
     */
    public GentablesBuilder()
    {
        super();
    }

    /**
     * Build using the Magic Lantern <i>gentables</i> command utiltity.
     * 
     ...
     * while running <i>gentables</i>.
     */
    protected void fullBuild(final IProgressMonitor monitor) throws CoreException
    {
        try
        {
            getProject().accept(new GentablesBuildVisitor(monitor));
        ...
        throws CoreException
    {
         ...
         delta.accept(new GentablesIncrementalBuildVisitor(monitor));
    }

    /**
     * Remove the derived assets generated by <i>gentables</i>.
     *
     * @param monitor A progress monitor to use during the build.
     */
    protected void clean(IProgressMonitor monitor)
    {
    	...
    	try
    	{
    	    ...
    	    // Remove the generated "MleRuntimeTables.java" file.
    	    String tableFile;
    	    if (DwpProjectManager.getInstance().isJavaProject(project))
    	        tableFile = new String("MleRuntimeTables.java");
    	    else
    	    	tableFile = new String("mltables.cxx");
    	    String filename = new String(destDir + "/" + tableFile);
    	...
    	{
    		DppLog.logError(ex,"Error occurred while deleting gentables artifacts.");
    	}
     }
