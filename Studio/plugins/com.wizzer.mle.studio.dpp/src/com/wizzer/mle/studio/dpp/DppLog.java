 ...
 * Magic Lantern Studio DPP plug-in.
 * <p>
 ...
 * @author Mark S.Millard
 */
public class DppLog implements ILog
{
	// A singlton instance of the DPP log.
	private static DppLog m_log = null;
	...
	{
		if (DppPlugin.getDefault() != null)
			DppPlugin.getDefault().getLog().log(
				new Status(Status.ERROR, DppPlugin.getID(), Status.OK, message, ex));
	}
	...
	private static void logEclipseWarning(String message)
	{
		if (DppPlugin.getDefault() != null)
			DppPlugin.getDefault().getLog().log(
				new Status(Status.WARNING, DppPlugin.getID(), Status.OK, message, null));
	}
	...
	private static void logEclipseInfo(String message)
	{
		if (DppPlugin.getDefault() != null)
			DppPlugin.getDefault().getLog().log(
				new Status(Status.INFO, DppPlugin.getID(), Status.OK, message, null));
	}
	
	/**
	 * Get the singleton instance of the DPP Log. If the instance does not yet
	 * exist, it will be created.
	 * 
	 * @return A reference to a <code>DppLog</code> is returned.
	 */
	public static DppLog getInstance()
	{
		if (m_log == null)
			m_log = new DppLog();
		return m_log;
	...
	/**
	 * Log an error to the global DPP log.
	 * <p>
	 * The message will be logged to <code>System.err</code> as well as the Eclipse log file.
	 * This method will also print a stack trace for the specified exception.
	 * </p>
	...
	{
		DppLog log = getInstance();
		log.error(ex,message);
	}

	/**
	 * Log a warning message to the global DPP log.
	 * <p>
	 * The message will be logged to <code>System.out</code> as well as the Eclipse log file.
	 * </p>
	 * 
	...
	/**
	 * Log an informative message to the global DPP log.
	 * <p>
	 * The message will be logged to <code>System.out</code> as well as the Eclipse log file.
	 * </p>
	 * 
