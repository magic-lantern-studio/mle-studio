...
public class MleAndroidImportProjectWizard extends MleStudioImportProjectWizard
{
	@Override
	public boolean performFinish()
	{
        ...
        {
        	AndroidLog.logError(ex, "Unable to complete the import of project " + m_projectPage.getProjectName() + " due to the following error: " + ex.getMessage());
            ...
            {
            	AndroidLog.logError(ex, "Unable to delete aborted import of project " + m_projectPage.getProjectName() + " due to the following error: " + ce.getMessage());            	
            }
    ...
    private void updateMetaData(IProject project, MleTitleMetaData metadata)
    {
        ...
        if (projectData.length > 0)
        {
        	...
        	try {
				...
				AndroidLog.logError(e, "Unable to configure project " + project.getName() + ": "+ e.getMessage());
    ...
    public IWizardPage getNextPage(IWizardPage page)
    {
        ...
        if (nextPage instanceof MleStudioMetaDataPage)
        {
            ...
            {
            	AndroidLog.logError(ex, "Unable to process meta-data for " + m_projectPage.getProjectName() + ".");
