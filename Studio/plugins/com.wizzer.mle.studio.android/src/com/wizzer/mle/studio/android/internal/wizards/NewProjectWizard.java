...
public class NewProjectWizard extends Wizard implements INewWizard {
    ...
    protected NewProjectWizardState mValues;
    ...
    public boolean performFinish() {
		MleProjectOverwriteQuery overwriteQuery = new MleProjectOverwriteQuery(getShell());
		
        NewProjectCreator creator = new NewProjectCreator(mValues, getContainer(), overwriteQuery);
     ...
     *
     * @return The current package name, or <b>null</b>.
     */
    ...
    /**
     * Returns the project name set by the wizard.
     * 
     * @return The current project name.
     */
    public String getProjectName() {
    	return mValues.projectName;
    }
