 ...
 * Magic Lanatern Digital Workprint <code>DwpSourceFileAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpSourceFileCellEditor extends DwpNameCellEditor
{
	 ...
	 */
	public DwpSourceFileCellEditor(Composite parent)
	{
		super(parent);
	 ...
	 */
	public DwpSourceFileCellEditor(Composite parent, int style)
	{
		super(parent,style);
