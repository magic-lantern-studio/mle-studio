/*
 * DwpDSOFileCellEditorFactory.java
 ...
 * Magic Lantern Digital Workprint <code>DwpDSOFileAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpDSOFileCellEditorFactory implements IAttributeCellEditorFactory
{
	/**
	 * The default constructor.
	 */
	public DwpDSOFileCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>DwpDSOFileAttribute</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>DwpDSPFileCellEditor</code> is returned.
	...
	{
		return new DwpDSOFileCellEditor(parent);
	}
