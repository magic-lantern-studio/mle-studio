/*
 * DwpVector2PropertyCellEditor.java
 ...
 */
public class DwpVector2PropertyCellEditor extends DwpNameTypeValueCellEditor
{
	/**
	 ...
	 */
    public DwpVector2PropertyCellEditor(Composite parent)
    {
        super(parent);
    }
	 ...
	 */
    public DwpVector2PropertyCellEditor(Composite parent, int style)
    {
        super(parent, style);
    }

	/**
	 * Sets the <code>DwpVector2PropertyAttribute</code> for the editor.
	 * 
	 * @param attr A reference to the <code>DwpVector2PropertyAttribute</code> to use with the
	 * editor.
	 * 
	...
	{
		if (! (attr instanceof DwpVector2PropertyAttribute))
			System.out.println("XXX: Throw An Exception!");
		else
			m_attribute = (DwpNameTypeValueAttribute)attr;
        
		//String val  = attr.toString();
		String valueName  = ((DwpVector2PropertyAttribute)attr).getValueName();
		String valueType  = ((DwpVector2PropertyAttribute)attr).getValueType();
		Float[] valueValue = (Float[])((DwpVector2PropertyAttribute)attr).getValueValue();
