 ...
 * while working with a <i>Digital Workprint</i>.
 * 
...
public class DwpException extends Exception
{
	 ...
	 */
	public DwpException(String message)
	{
		super(message);
	}
	 ...
	 */
	public DwpException(String message, Throwable cause)
	{
		super(message,cause);
	}
	 ...
	 * and indicates that the cause is nonexistent or unknown.
	 */
	public DwpException(Throwable cause)
	{
		super(cause);
	}
}
