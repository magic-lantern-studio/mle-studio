 ...
 * Magic Lanatern Digital Workprint <code>DwpHeaderFileAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpHeaderFileCellEditor extends DwpNameCellEditor
{
	 ...
	 */
	public DwpHeaderFileCellEditor(Composite parent)
	{
		super(parent);
	 ...
	 */
	public DwpHeaderFileCellEditor(Composite parent, int style)
	{
		super(parent,style);
