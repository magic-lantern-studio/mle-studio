...
import com.wizzer.mle.studio.dwp.attribute.DwpNameTypeAttribute;


/**
 * This class is a Eclipse SWT <code>CellEditor</code> for the Wizzer Works
 * Magic Lanatern Digital Workprint <code>DwpNameTypeAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpNameTypeCellEditor extends AttributeCellEditor
{
	// The Attribute.
	private DwpNameTypeAttribute m_attribute = null;
	 ...
	 */
	public DwpNameTypeCellEditor(Composite parent)
	{
		super(parent);
	 ...
	 */
	public DwpNameTypeCellEditor(Composite parent, int style)
	{
		super(parent,style);
	...
	private void initGUI(Composite parent)
	{
		...
		m_nameText.addFocusListener(new FocusAdapter() {
			public void focusLost(FocusEvent e) {
				DwpNameTypeCellEditor.this.focusLost();
			}
		});
	 ...
	 * and deactivates the cell editor. The <code>DwpNameTypeAttribute</doce> is also updated
	 * if necessary.
	 * </p>
	 * 
	...
	/**
	 * Complete cell editing. The <code>DwpNameTypeAttribute</code> is updated.
	 * 
	...
	public boolean stopCellEditing()
	{
		...
		m_attribute.setValue(name,type);
	...
	/**
	 * Sets the <code>DwpNameTypeAttribute</code> for the editor.
	 * 
	...
	{
		if (! (attr instanceof DwpNameTypeAttribute))
			System.out.println("XXX: Throw An Exception!");
		else
			m_attribute = (DwpNameTypeAttribute)attr;
        
		//String val  = attr.toString();
		String valueName  = ((DwpNameTypeAttribute)attr).getValueName();
		String valueType  = ((DwpNameTypeAttribute)attr).getValueType();
		...
		if (! m_label.isDisposed()) {
			...
			m_label.setToolTipText("String [" + attr.getName() + "] - bits = " +
				attr.getBits() + " - value = " + ((DwpNameTypeAttribute)attr).getValue());
		}
	}
