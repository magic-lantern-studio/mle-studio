 ...
 * Magic Lantern Digital Workprint <code>DwpNameAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpNameCellEditorFactory implements IAttributeCellEditorFactory
{
	/**
	 * The default constructor.
	 */
	public DwpNameCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>DwpNameCellEditor</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>DwpNameCellEditor</code> is returned.
	...
	{
		return new DwpNameCellEditor(parent);
	}
