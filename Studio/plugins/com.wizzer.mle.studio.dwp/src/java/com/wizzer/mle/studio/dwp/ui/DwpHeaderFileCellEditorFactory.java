/*
 * DwpHeaderFileCellEditorFactory.java
 ...
 * Magic Lantern Digital Workprint <code>DwpHeaderFileAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpHeaderFileCellEditorFactory implements IAttributeCellEditorFactory
{
	/**
	 * The default constructor.
	 */
	public DwpHeaderFileCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>DwpHeaderFileAttribute</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>DwpHeaderFileCellEditor</code> is returned.
	...
	{
		return new DwpHeaderFileCellEditor(parent);
	}
