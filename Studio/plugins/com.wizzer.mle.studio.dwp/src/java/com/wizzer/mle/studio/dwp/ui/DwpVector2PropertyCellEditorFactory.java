/*
 * DwpVector2PropertyCellEditorFctory.java
 ...
 * Magic Lantern Digital Workprint <code>DwpVector2PropertyAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpVector2PropertyCellEditorFactory implements IAttributeCellEditorFactory 
{
	/**
	 * The default constructor.
	 */
	public DwpVector2PropertyCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>DwpVector2PropertyCellEditor</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>DwpVector2PropertyCellEditor</code> is returned.
	...
	{
		return new DwpVector2PropertyCellEditor(parent);
	}
