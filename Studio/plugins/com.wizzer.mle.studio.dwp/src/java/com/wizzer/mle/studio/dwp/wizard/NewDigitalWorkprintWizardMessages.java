/**
 * NewDigitalWorkprintWizardMessages.java
 * Created on October 8, 2010
 */
 ...
 */
public class NewDigitalWorkprintWizardMessages
{
    // The name of the resource bundle.
	private static final String RESOURCE_BUNDLE = NewDigitalWorkprintWizardMessages.class.getName();
	// The resource bundle.
	private static ResourceBundle g_resourceBundle = ResourceBundle.getBundle(RESOURCE_BUNDLE);

	// Hide the default constructor.
	private NewDigitalWorkprintWizardMessages()
	{
		// Do nothing for now.
	}
