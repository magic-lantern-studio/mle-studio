/*
 * DwpRotationPropertyCellEditorFctory.java
 ...
 * Magic Lantern Digital Workprint <code>DwpRotationPropertyAttribute</code>.
 * 
 * @author Mark S. Millard
 */
public class DwpRotationPropertyCellEditorFactory implements IAttributeCellEditorFactory 
{
	/**
	 * The default constructor.
	 */
	public DwpRotationPropertyCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>DwpRotationPropertyCellEditor</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>DwpRotationPropertyCellEditor</code> is returned.
	...
	{
		return new DwpRotationPropertyCellEditor(parent);
	}
