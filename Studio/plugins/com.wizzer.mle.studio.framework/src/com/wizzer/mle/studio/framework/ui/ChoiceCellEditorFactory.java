 ...
 */
public class ChoiceCellEditorFactory implements IAttributeCellEditorFactory
{
	/**
	 * The default constructor.
	 */
	public ChoiceCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>ChoiceCellEditor</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>ChoiceCellEditor</code> is returned.
	...
	{
		return new ChoiceCellEditor(parent);
	}
