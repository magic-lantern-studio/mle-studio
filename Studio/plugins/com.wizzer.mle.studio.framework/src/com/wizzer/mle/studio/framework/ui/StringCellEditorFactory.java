 ...
 */
public class StringCellEditorFactory implements IAttributeCellEditorFactory
{
	/**
	 * The default constructor.
	 */
	public StringCellEditorFactory()
	{
		super();
	}

	/**
	 * Create an instance of the <code>StringCellEditor</code>.
	 * 
	 * @param parent The parent <code>Composite</code> widget of the Cell Editor.
	 * 
	 * @return An instance of a <code>StringCellEditor</code> is returned.
	...
	{
		return new StringCellEditor(parent);
	}
