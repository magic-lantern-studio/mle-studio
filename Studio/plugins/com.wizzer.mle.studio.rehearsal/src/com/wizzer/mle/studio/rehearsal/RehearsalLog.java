 ...
 * Magic Lantern Studio Rehearsal Player plug-in.
 * <p>
 ...
 * @author Mark S.Millard
 */
public class RehearsalLog implements ILog
{
	// A singlton instance of the Magic Lantern Studio Rehearsal Player log.
	private static RehearsalLog m_log = null;
	...
	{
		if (RehearsalPlugin.getDefault() != null)
			RehearsalPlugin.getDefault().getLog().log(
				new Status(Status.ERROR, RehearsalPlugin.getID(), Status.OK, message, ex));
	}
	...
	private static void logEclipseWarning(String message)
	{
		if (RehearsalPlugin.getDefault() != null)
			RehearsalPlugin.getDefault().getLog().log(
				new Status(Status.WARNING, RehearsalPlugin.getID(), Status.OK, message, null));
	}
	...
	private static void logEclipseInfo(String message)
	{
		if (RehearsalPlugin.getDefault() != null)
			RehearsalPlugin.getDefault().getLog().log(
				new Status(Status.INFO, RehearsalPlugin.getID(), Status.OK, message, null));
	}
	
	/**
	 * Get the singleton instance of the Magic Lantern Studio Rehearsal Player Log. If the instance does not yet
	 * exist, it will be created.
	 * 
	 * @return A reference to a <code>RehearsalLog</code> is returned.
	 */
	public static RehearsalLog getInstance()
	{
		if (m_log == null)
			m_log = new RehearsalLog();
		return m_log;
	}
	...
	/**
	 * Log an error to the global Magic Lantern Studio Rehearsal Player log.
	 * <p>
	 * The message will be logged to <code>System.err</code> as well as the Eclipse log file.
	 * This method will also print a stack trace for the specified exception.
	 * </p>
	...
	{
		RehearsalLog log = getInstance();
		log.error(ex,message);
	}

	/**
	 * Log a warning message to the global Magic Lantern Studio Rehearsal Player log.
	 * <p>
	 * The message will be logged to <code>System.out</code> as well as the Eclipse log file.
	 * </p>
	 * 
	...
	/**
	 * Log an informative message to the global Magic Lantern Studio Rehearsal Player log.
	 * <p>
	 * The message will be logged to <code>System.out</code> as well as the Eclipse log file.
	 * </p>
	 * 
