...
import com.wizzer.mle.codegen.IsmdefsTemplate;
...
/**
 * This class is used to generate the Magic Lantern C/C++ Ismdefs Makefile.
 * 
 * @author Mark S. Millard
 */
public class MleIsmdefsMakefile extends AbstractMakefile
{
	// The Makefile template.
	private IsmdefsTemplate m_template;
	 ...
	 * the Ismdefs Makefile can not be constructed.
	 */
	public MleIsmdefsMakefile(IProject project)
	    throws DppException
	{
		super(project);
    ...
    /**
     * Generate the Ismdefs Makefile.
     * 
     * @return A <code>ByteArrayOutputStream</code> is returned.
     * 
     * @throws IOException This exceptionis thrown if the Ismdefs Makefile can
     * not be generated.
     */
