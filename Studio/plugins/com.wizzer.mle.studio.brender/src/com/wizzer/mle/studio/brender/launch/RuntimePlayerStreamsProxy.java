/*
 * RuntimePlayerStreamsProxy.java
 ...
 * <code>RuntimePlayerProcess<.code>.
 * <p>
 * Currently it is just a placeholder that does nothing.
 * </p>
 * @author Mark S. Millard
 */
public class RuntimePlayerStreamsProxy implements IStreamsProxy
{
	// The stream monitor for output messages.
    private RuntimePlayerStreamMonitor m_outputMonitor = new RuntimePlayerStreamMonitor();
    // The stream monitor for the error messages.
    private RuntimePlayerStreamMonitor m_errorMonitor = new RuntimePlayerStreamMonitor();
    
	/**
	 * The default constructor.
	 */
	public RuntimePlayerStreamsProxy()
	{
		super();
	}
