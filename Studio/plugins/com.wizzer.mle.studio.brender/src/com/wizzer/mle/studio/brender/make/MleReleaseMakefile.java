...
import com.wizzer.mle.codegen.ReleaseMakefileTemplate;
...
/**
 * This class is used to generate the Magic Lantern C/C++ Release Makefile
 * in the Release directory.
 *  
 * @author Mark S. Millard
 */
public class MleReleaseMakefile extends AbstractMakefile
{
	// The Makefile template.
	private ReleaseMakefileTemplate m_template;
	 ...
	 */
	public MleReleaseMakefile(IProject project)
	    throws DppException
	{
		super(project);
