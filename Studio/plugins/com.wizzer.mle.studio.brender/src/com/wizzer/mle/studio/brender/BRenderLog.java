 ...
 * Magic Lantern Studio BRender plug-in.
 * <p>
 ...
 */
public class BRenderLog implements ILog
{
	// A singleton instance of the BRender log.
	private static BRenderLog m_log = null;
	...
	/**
	 * Get the singleton instance of the BRender Log. If the instance does not yet
	 * exist, it will be created.
	 * 
	 * @return A reference to a <code>DppLog</code> is returned.
	 */
	public static BRenderLog getInstance()
	{
		if (m_log == null)
			m_log = new BRenderLog();
		return m_log;
	}
	...
	/**
	 * Log an error to the global BRender log.
	 * <p>
	 * The message will be logged to <code>System.err</code> as well as the Eclipse log file.
	 * This method will also print a stack trace for the specified exception.
	 * </p>
	...
	{
		BRenderLog log = getInstance();
		log.error(ex,message);
	}

	/**
	 * Log a warning message to the global BRender log.
	 * <p>
	 * The message will be logged to <code>System.out</code> as well as the Eclipse log file.
	 * </p>
	 * 
	...
	/**
	 * Log an informative message to the global BRender log.
	 * <p>
	 * The message will be logged to <code>System.out</code> as well as the Eclipse log file.
	 * </p>
	 * 
