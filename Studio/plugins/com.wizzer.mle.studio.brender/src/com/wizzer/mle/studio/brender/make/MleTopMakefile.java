...
import com.wizzer.mle.codegen.TopMakefileTemplate;
...
/**
 * This class is used to generate the Magic Lantern C/C++ Top Level Makefile.
 *  
 * @author Mark S. Millard
 */
public class MleTopMakefile extends AbstractMakefile
{
	// The Makefile template.
	private TopMakefileTemplate m_template;
	 ...
	 */
	public MleTopMakefile(IProject project)
	    throws DppException
	{
		super(project);
    ...
    /**
     * Generate the Top Makefile.
     * 
     * @return A <code>ByteArrayOutputStream</code> is returned.
     * 
     * @throws IOException This exception is thrown if the Top Makefile can
     * not be generated.
     */
