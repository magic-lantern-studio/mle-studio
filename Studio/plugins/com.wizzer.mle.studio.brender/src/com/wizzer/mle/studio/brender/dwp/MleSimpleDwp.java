...
// Declare package.
package com.wizzer.mle.studio.brender.dwp;
...
import com.wizzer.mle.codegen.SimpleBRenderDwpTemplate;
import com.wizzer.mle.studio.dwp.AbstractDigitalWorkprint;

/**
 * This class is used to generate the Magic Lantern Simple BRender DWP
...
public class MleSimpleDwp extends AbstractDigitalWorkprint
{
	...
	private SimpleBRenderDwpTemplate m_template;
	...
	{
		super(project);
		m_template = new SimpleBRenderDwpTemplate();
		init();
	}
